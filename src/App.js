...
import EjemploRedux from "./components/redux/components/EjemploRedux";
    ...
    return (
      <div className="App">
        ...
        >
          ...
          puede lanzar eventos que gestionará el componente. No puede
        ...
        <PatronSimpleContraible
          style={this.estiloPatron}
          titulo="REDUX"
          componente="ver components/redux"
          isExpanded={this.state.expandedREDUX}
          onClick={() => this.expandOrCollapse("REDUX")}
        >
          <p>
            Separación entre componentes de presentación y Contenedores{" "}
            <a href="https://redux.js.org/basics/usage-with-react#presentational-and-container-components">
              link
            </a>
          </p>
          <EjemploRedux />
        ...
        <Bibliografia titulo="Bibliografia">
          ...
          />
          <EnlaceBibli
            url="https://medium.com/edge-coders/the-difference-between-flux-and-redux-71d31b118c1"
            descripcion="The difference between Flux and Redux"
          />
          <EnlaceBibli
            url="https://github.com/facebook/flux"
            descripcion="Flux"
          />
          <EnlaceBibli url="https://es.redux.js.org/" descripcion="REDUX" />
          <EnlaceBibli
            url="https://redux.js.org/basics/example"
            descripcion="REDUX - Ejemplo básico (el que he copiado)"
          />
          <EnlaceBibli
            url="https://egghead.io/courses/getting-started-with-redux"
            descripcion="Videos - getting started with redux"
          />
          <EnlaceBibli
            url="https://redux.js.org/introduction/getting-started"
            descripcion="REDUX - getting started"
          />
          <EnlaceBibli
            url="https://redux.js.org/basics/usage-with-react"
            descripcion="REDUX - Usage with React"
          />
          <EnlaceBibli
            url="https://github.com/reduxjs/redux-thunk"
            descripcion="REDUX thunk - lógica asíncrona"
          />
        </Bibliografia>
      </div>
    );
